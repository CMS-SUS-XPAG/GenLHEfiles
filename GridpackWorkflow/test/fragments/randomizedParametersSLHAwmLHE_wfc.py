...
externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.3.3/sus_sms/SMS-TChiSlepSnu/SMS-TChiSlepSnu_mChi-700_tarball.tar.xz'),
...
for i in range(m_c1/step):
  m_lsp = 0. + i*step
  # 50 GeV step above m_lsp of 300 GeV
  if m_lsp>300 and i%2==1: continue 
  m_slep = m_lsp + 0.5*(m_n2-m_lsp)
