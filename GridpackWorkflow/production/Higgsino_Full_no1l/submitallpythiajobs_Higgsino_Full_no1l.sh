...
for MU in 180; do
    for M1 in 300; do
        ...
        python ${SCRIPT} ${MODEL} --in-dir /hadoop/cms/store/user/${USER}/mcProduction/LHE/${MODEL} --slha /home/users/lshchuts/GenLHEfiles/GridpackWorkflow/production/Higgsino_Full_no1l/slha/susyhit_slha_${MUSTR}_${M1STR}.out --qcut-range 76 76 --proxy ${vomsdir} --nJetMax 2 --no-sub
    done
done
