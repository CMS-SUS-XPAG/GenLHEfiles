...
#    Constructing grid
mpoints = []
mpoints.append([175, 7.5, nevt])
mpoints.append([225, 20, nevt])
mpoints.append([150, 30, nevt])

for point in mpoints:

    mc1, dM = point[0], point[1]
    mn1 = mc1 - dM
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.3.3/sus_sms/SMS-C1C1/v2/%s_mChi-%s_tarball.tar.xz' % (process,mc1Str)),
            ConfigDescription = cms.string('%s_%s_%s' % (model, mc1Str,mn1Str)),
