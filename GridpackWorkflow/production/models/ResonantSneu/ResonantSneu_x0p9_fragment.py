...
model = "ResonantSneu_x0p9"

def events(mx):
  if (mx<800): return 50
  elif (mx<1500): return 35
  else: return 25
...
for point in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.3.3/sus_sms/ResonantSneu_x0p9/resSmuSM2_mSlep_%i_mN1_%i_x_0p9_tarball.tar.xz' % (mslep, mchi)),
