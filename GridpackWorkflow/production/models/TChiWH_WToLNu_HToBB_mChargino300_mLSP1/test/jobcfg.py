...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TChiWH_WToLNu_HToBB_mChargino300_mLSP100_fragment.py nevts:4'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:TChiWH_WToLNu_HToBB_mChargino300_mLSP100_1.root'),
