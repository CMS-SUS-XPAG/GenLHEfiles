...
def matchParams(mass):
    if mass < 199: return 76,0.580
    elif mass < 299: return 76,0.525
    elif mass < 499: return 76,0.457
    else: return 76,0.457
...
for point in mpoints:
    ...
    qcut, tru_eff = matchParams(m_slep)
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.3.3/sus_sms/SMS-SlepSlep/v2/SMS-TSlepSlep_mSlep-%i_tarball.tar.xz' % m_slep),
            ConfigDescription = cms.string('%s_%i_%i' % (model, m_slep, mlsp)),
