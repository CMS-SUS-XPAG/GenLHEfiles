...
for point in mpoints:
    ...
    slhatable = baseSLHATable.replace('%MSMU%','%e' % mslep)
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.3.3/sus_sms/ResonantSmuSM1/resSmuSM1_mSlep_%i_mN1_%i_tarball.tar.xz' % (mslep, mchi)),
