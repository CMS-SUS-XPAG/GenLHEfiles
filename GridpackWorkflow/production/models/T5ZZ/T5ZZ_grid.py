...
makePlot(cols, 'events', model, process, xmin, xmax, ymin-100, ymax)
Ntot = makePlot(cols, 'lumi', model, process, xmin, xmax, ymin-100, ymax)
makePlot(cols, 'lumi_br5', model, process, xmin, xmax, ymin-100, ymax)
