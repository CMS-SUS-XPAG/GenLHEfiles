...
model = "SMS-C1N1-higgsino"
process = "Higgsino-C1N1"
...
for point in mpoints:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            GridpackPath =  cms.string('/cvmfs/cms.cern.ch/phys_generator/gridpacks/slc6_amd64_gcc481/13TeV/madgraph/V5_2.4.2/sus_sms/%s/v1/%s_mC1-%s_mN1-%s_tarball.tar.xz' % (process,process,mc1Str,mn1Str)),
