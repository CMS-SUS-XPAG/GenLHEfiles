...
scanBlocks = []
scanBlocks.append(gridBlock(800, 1000, 100, 100, 100, 150))
scanBlocks.append(gridBlock(1000, 1800, 50, 100, 50, 150))
minDM = 10
ymin, ymed, ymax = 200, 900, 1800
hlines_below_grid = [112.5,125,150,175]
hline_xmin = 1000
